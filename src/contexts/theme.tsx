...
export type ThemeValue = [boolean, (isDarkModeEnabled: boolean) => void];
...
const useThemeChange = (theme: ThemeValue): void => {
  ...
  useEffect(() => {
    ...
    browserStorage.setItem(DARK_MODE, isDarkModeEnabled);
...
export function ThemeProvider({ children }: ThemeProviderProps): JSX.Element {
  const isDarkMode = useMemo(() => {
    ...
    return isUserPreferenceSet ? userPreference : true; //isSystemDarkMode;
  }, []);
